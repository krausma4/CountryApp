...
pl.v.internationalOrganizations.manage ={
  ...
  setupUserInterface: function (){
    window.addEventListener(
        "beforeunload",pl.v.internationalOrganizations.manage.exit);
  ...
  refreshUI: function(){
    document.getElementById("organizationMenu").style.display = "block";
    document.getElementById("organizationRead").style.display = "none";
    document.getElementById("organizationCreate").style.display = "none";
    document.getElementById("organizationUpdate").style.display = "none";
    document.getElementById("organizationDelete").style.display = "none";
  }
};
...
pl.v.internationalOrganizations.list = {
  setupUserInterface: function () {
    ...
    var tableBodyEl = document.querySelector(
        "section#organizationRead>table>tbody");
    ...
    document.getElementById("organizationMenu").style.display = "none";
    document.getElementById("organizationRead").style.display = "block";
  }
};
...
pl.v.internationalOrganizations.create = {
   ...
   */
  setupUserInterface: function () {
    var formEl = document.querySelector("section#organizationCreate > form"),
    ...
    formEl.acronym.addEventListener("input", function () {
      formEl.acronym.setCustomValidity(
          InternationalOrganizations.checkAcronymAsId(
              formEl.acronym.value).message);
    });
    formEl.selectMembers.addEventListener("change",function () {
      
     // formEl.selectMembers.setCustomValidity(
        // InternationalOrganizations.checkMember(formEl.selectMembers));
    ...
    document.getElementById("organizationMenu").style.display = "none";
    document.getElementById("organizationCreate").style.display = "block";
    formEl.reset();
  },
  
  
  handleSubmitButtonClickEvent: function () {
    var i=0, formEl = document.querySelector("section#organizationCreate > form"),
    ...
    formEl.name.setCustomValidity(
        InternationalOrganizations.checkName(slots.name).message);
    formEl.acronym.setCustomValidity(
        InternationalOrganizations.checkAcronymAsId(slots.acronym).message);
...
pl.v.internationalOrganizations.destroy = {
  ...
  setupUserInterface: function () {
    ...
    deleteButton.addEventListener("click", function () {
      var formEl = document.querySelector("section#organizationDelete > form");
...
pl.v.internationalOrganizations.update = {
   ...
   */
  setupUserInterface: function () {
    var formEl = document.querySelector("section#organizationUpdate > form"),
    ...
    formEl.addEventListener('submit', function (e) {
      var membersSelWidget = document.querySelector(
          "section#organizationUpdate > form .MultiSelectionWidget");
      e.preventDefault();
      membersSelWidget.innerHTML = "";
      formEl.reset();
    });
    document.getElementById("organizationMenu").style.display = "none";
    document.getElementById("organizationUpdate").style.display = "block";
    formEl.reset();
  },
  /**
  ...
  handleSubmitButtonClickEvent: function () {
    var assocMemberListItemEl=null, membersIdRefToRemove=[],
        ...
        formEl = document.querySelector("section#organizationUpdate > form"),
        membersSelWidget = formEl.querySelector(".MultiSelectionWidget"),
